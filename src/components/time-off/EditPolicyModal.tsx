    ...
    <div className="fixed inset-0 bg-background/80 flex items-center justify-center z-50 p-4">
      <div className="bg-card rounded-lg p-4 sm:p-6 w-full max-w-lg overflow-y-auto max-h-[90vh] border border-card-border shadow-lg">
        <div className="flex justify-between items-center mb-4 sm:mb-6">
          <h2 className="text-xl sm:text-2xl font-semibold text-platinum">{t('editPolicyModal.title')}</h2> 
          <button onClick={onClose} className="text-sunset hover:text-primary text-xl sm:text-2xl leading-none">
            &times;
          </button>
        </div>
